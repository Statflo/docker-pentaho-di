...
# Build Args
ARG PDI_RELEASE="8.0"
ARG PDI_VERSION="8.0.0.0-28"
ARG PENTAHO_DIR="/opt/pentaho"
ARG MYSQL_CONNECTOR_VERSION="5.1.41"
ARG PDI_HOME="$PENTAHO_DIR/data-integration"
ARG PDI_DOWNLOAD_URL="http://downloads.sourceforge.net/project/pentaho/Pentaho%20$PDI_RELEASE/client-tools/pdi-ce-$PDI_VERSION.zip"
